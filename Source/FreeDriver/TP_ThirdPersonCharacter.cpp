...
void ATP_ThirdPersonCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("EnterVehicle", IE_Pressed, this, &ATP_ThirdPersonCharacter::EnterVehicle);
...
void ATP_ThirdPersonCharacter::EnterVehicle()
{
	//for ( TActorIterator<AFreeDriverPawn> Vehicle(GetWorld()); Vehicle; ++Vehicle )
	//for (TActorIterator<AFreeDriverPawn> Vehicle(GetWorld()); Vehicle; ++Vehicle)
	//{
		//if (Vehicle->getDistance)
	//}

	for (TActorIterator<AFreeDriverPawn> Vehicle(GetWorld()); Vehicle; ++Vehicle)
	{
		if (Vehicle->GetDistanceTo(this) < 500.f)
		{
